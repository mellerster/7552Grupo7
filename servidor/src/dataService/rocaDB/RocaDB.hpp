...
class RocaDB : public IDB {
    public:
        ...
        virtual bool StoreUserUbicacion(std::string userID, std::string latitud, std::string longitud, std::string fechaHora);
        virtual bool LoadUserUbicacion(std::string userID, std::string &latitud, std::string &longitud, std::string &fechaHora);
